...
function QuizCreateForm() {
    const { mutate, isError, isLoading, isValue } = useCreateForm();
    ...
    const handleSubmit = async () => {
        ...
        if (isTitleValid && isDescriptionValid && areQuestionsValid) {
            ...
            // Format the questions for the backend
            const formattedQuestions = questions.map((q, index) => ({
                question: q.text, 
                position: index,
                type: 'single', // will have to improve
            ...
            console.log("Quiz payload being sent:", quizData);
